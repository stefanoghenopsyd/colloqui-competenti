...
def salva_su_google_sheet(dati):
    ...
    try:
        ...
        # Verifica se i segreti esistono
        ...
        # Stampa l'errore in console ma non blocca l'utente
    ...
    **Benvenuto/a.**
    ...
    if submitted:
        if not nome:
            ...
            saved = salva_su_google_sheet(record)
            if not saved:
                st.warning("Nota: I dati non sono stati salvati su Drive (database non configurato), ma ecco il tuo profilo.")
            ...
            # Feedback Condizionali (Soglia < 4 su scala 6)
